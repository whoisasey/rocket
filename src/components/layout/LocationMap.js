...
const LocationMap = (props) => {
	...
	// this array only contains information pertaining to origin and destination addresses. if the user decides to select an origin and/or destination address, it will be removed from the array so that the map won't add that location
	let data = []
	...
	// to use our data as waypoints in the google directions API, we have to add a pipe (|) at the end of every item except the last one 
